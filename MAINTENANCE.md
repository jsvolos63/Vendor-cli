...
This repo's own health is the shortest thing in this file: 211 tests green,
...
| `npm test` | `node --test` over **nine explicitly named files** — `test/test.mjs`, `test/tooling.test.mjs`, `test/claude-md-sync.test.mjs`, `test/maintenance-sync.test.mjs`, `test/family-liveness.test.mjs`, `test/maintenance-doc-check.test.mjs`, `test/sanitizer-policy-sync.test.mjs`, `test/module-graph.test.mjs`, `test/workflows.test.mjs`. 211 cases, ~17 s. |
